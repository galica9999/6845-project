	...
	<div class="ui bottom attached header">
		<form class="ui form" name="createVolunteerTask" method='POST'>
			<div class="inline fields">
				<div >
					<label><?php if (isset($taskID)) {echo 'Update task:';} else {echo 'Create task:';} ?></label>
<!--
